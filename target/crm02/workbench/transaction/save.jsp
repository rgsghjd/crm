...
<script>
	$(function () {
		...
		$("#create-stage").change(function () {
			...
			var key=$("#create-stage").val()


			$("#create-possibility").val(stageJson[key])
		})
...
<body>
	...
	<form id="tranForm" action="workbench\transaction\createTran.do" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control time1" id="create-expectedDate" name="expectedClosingDate">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<select class="form-control" id="create-type" name="transactionType">
				  <option></option>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<select class="form-control" id="create-source" name="clueSource">
				  <option></option>
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="asource" value="a5ac142845594d2aa9c37f7f00cf76ba">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsName" value="093947355f344ff0ad58699fe00ff163">
			</div>
		</div>
