	...
	$(function(){
		...
		$("#bunBtn").click(function () {
			 ...
			 if($aid.length==0){
				 ...
				 $.ajax({
					 url:"workbench/clue/bun.do?cid=${c.id}&"+aid,
					 dataType:"json",
			...
			success:function (data) {
				...
				var html="";
					$.each(data,function (i,n) {
						...
						html +='<td>'+n.endDate+'</td>';
						html +='<td>'+n.owner+'</td>';
						html +='<td><a href="javascript:void(0);" onclick="unBun(\''+n.id+'\')" style="text-decoration: none;"><span class="glyphicon glyphicon-remove"></span>解除关联</a></td>';
						html +='</tr>';
					})
				$("#aList").html(html);
			}
...
<%--							</tr>--%>
				...
				<div class="modal-footer">
					...
					<button type="button" id="bunBtn" class="btn btn-primary" data-dismiss="modal">关联</button>
				</div>
			</div>
		</div>
	</div>
